...
namespace Morse_Code
{
        ...
        
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Choose language (russian, english, translit): [r/e]");
                ...
                using (StreamReader streamRead = File.OpenText(path_source))
                {
                    while (streamRead.Peek() != -1) //Работаем с исходным файлом, пока не дойдем до его конца
                    {
                        ...
                        if (answer == 'c') 
                        {
                            ...
                            {
                                bufString = Convert.ToChar(streamRead.Read());
                            ...
                            resultString = message.Code(Convert.ToChar(streamRead.Read()));
                        else
