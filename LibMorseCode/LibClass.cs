...
namespace LibMorseCode
{
    public class MorseCode
    {
        ...
        private const string PATH_EN = @"C:\Users\dotan\Desktop\C#\CM\EnglishDictionary.txt"; //Константа, хранящая адрес английского словаря
        private const string PATH_RUS = @"C:\Users\dotan\Desktop\C#\CM\RussianDictionary.txt"; //Константа, хранящая адрес русского словаря
        private const string PATH_TRANSLIT = @"C:\Users\dotan\Desktop\C#\CM\Translit.txt"; //Константа, хранящая адрес словаря с транслитом
